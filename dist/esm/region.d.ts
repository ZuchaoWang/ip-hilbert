 ...
 */
export declare function convertSquareToRect(s: Square): Rect;
/**
 ...
 */
export declare function isXYPosInSquare(x: number, y: number, s: Square): boolean;
/**
 ...
 */
export declare function isXYPosInRect(x: number, y: number, r: Rect): boolean;
