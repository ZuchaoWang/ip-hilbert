...
exports.SubnetHilbertMapper = void 0;
const byte2quart_1 = require("../byte2quart");
const prefix_1 = require("../prefix");
const quart2region_1 = require("../quart2region");
...
function calculateRefSquareInternal(refPrefix, gridMaskLen) {
    const refQuarts = (0, byte2quart_1.convertPrefixToQuartsAndBit)(refPrefix, 0).leadingQuarts;
    // only angle and flip are relevant, this is neither grid or internal coordinate system
    const refSquareUnitInGlobal = (0, quart2region_1.hilbertQuartsToSquareRegion)({ xc: 1, yc: 1, size: 2, angle: 0, flip: 1 }, refQuarts);
...
function calculateRectWithinRefSquareInternal(refSquareInternal, numQuartsSkip, prefix) {
    const { leadingQuarts, lastBit } = (0, byte2quart_1.convertPrefixToQuartsAndBit)(prefix, numQuartsSkip);
    const rectRegion = (0, quart2region_1.hilbertQuartsToRectRegion)(refSquareInternal, leadingQuarts, lastBit);
    return rectRegion;
}
/**
...
class SubnetHilbertMapper {
   ...
   */
    ...
    gridPosToPrefix(x, y) {
        ...
        if ((0, region_1.isXYPosInRect)(xInternal, yInternal, this._subnetRectInternal)) {
            const refQuarts = (0, byte2quart_1.convertPrefixToQuartsAndBit)(this._refPrefix, 0).leadingQuarts;
            const posQuarts = (0, quart2region_1.hilbertXYPosToQuartsInSquareRegion)(this._refSquareInternal, xInternal, yInternal, this._gridMaskLen / 2 - this._refPrefix.maskLen / 2);
            ...
            const bytes = (0, byte2quart_1.convertQuartsToBytes)(allQuarts);
    ...
    prefixToRectRegion(prefix) {
        if ((0, prefix_1.isPrefixContain)(this._subnetPrefix, prefix)) {
...
exports.SubnetHilbertMapper = SubnetHilbertMapper;
