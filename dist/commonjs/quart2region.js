...
exports.hilbertXYPosToQuartsInSquareRegion = exports.hilbertQuartsToRectRegion = exports.hilbertQuartsToSquareRegion = void 0;
 ...
 */
function hilbertQuartsToSquareRegion(s, leadingQuarts) {
...
exports.hilbertQuartsToSquareRegion = hilbertQuartsToSquareRegion;
/**
 ...
 */
function hilbertQuartsToRectRegion(s, leadingQuarts, lastBit) {
    const descendantSquare = hilbertQuartsToSquareRegion(s, leadingQuarts);
    if (lastBit === undefined) {
        return (0, region_1.convertSquareToRect)(descendantSquare);
    }
    else {
        return hilbertBitToHalfRectRegionOneStep(descendantSquare, lastBit);
    }
}
exports.hilbertQuartsToRectRegion = hilbertQuartsToRectRegion;
/**
 ...
 */
function hilbertXYPosToQuartsInSquareRegion(s, x, y, depth) {
    const quarts = [];
    const within = hilbertXYPosToQuartInSquareRegionOneStep(s, x, y, depth, quarts);
    return within ? quarts : undefined;
}
exports.hilbertXYPosToQuartsInSquareRegion = hilbertXYPosToQuartsInSquareRegion;
/**
...
function hilbertXYPosToQuartInSquareRegionOneStep(s, x, y, depth, quarts) {
    ...
    if (!(0, region_1.isXYPosInSquare)(x, y, s)) {
        return false;
    }
    else if (depth === 0) {
        return true;
