 ...
 */
export class CompositeHilbertMapper implements HilbertMapper {
  private _width: number;
  private _height: number;
  private _children: { mapper: HilbertMapper; offset: [number, number] }[];
  ...
  constructor(
    width: number,
    height: number,
    children: { mapper: HilbertMapper; offset: [number, number] }[],
  ) {
    this._width = width;
    this._height = height;
